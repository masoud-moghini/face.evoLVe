...
def get_val_pair(path, name):
    dataset = glob(os.path.join(path, name)+'/*')
...
def get_val_data(data_path):
    ...
    cfp_ff, cfp_ff_issame = None,None
    cfp_fp, cfp_fp_issame = None,None
    agedb_30, agedb_30_issame = None,None
    calfw, calfw_issame = None,None
    cplfw, cplfw_issame = None,None
    vgg2_fp, vgg2_fp_issame = None,None
